...
class ComponentBuilder extends AbstractAssetBuilder
{
    ...
    public function build()
    {
        ...
        foreach ($this->_app->getModules() as $module) {
            ...
            $moduleComponentsPath = $this->_app->getName() . '/' . $module->getName() . '/Js/Components';
            ...
            foreach ($componentsDir as $item) {
                ...
                if ($lmLog && $lmLog >= $lmComponent) {
                    $this->_log("- Component `" . $componentName . "` was not modified.");
                    continue;
                }

                $this->_log("- Component `" . $componentName . "` will be built!");
