    ...
    registerOptions(items = null, children = null) {
        ...
        if (items) {
            ...
            React.Children.map(children, (child) => {
                ...
                if (child.type === Ui.NestedCheckboxGroup && !this.checkboxChildren.length) {
        ...
        if (value) {
            if (_.isArray(value)) {
                _.keys(value).forEach(key => {
                    const valueKey = this.props.checkedPrefix + this.props.valueAttr;
                    if (_.isPlainObject(value[key])) {
                        data[_.get(value, key + '.' + valueKey)] = true;
                    } else {
                        data[value[key]] = true;
                    }
                });
