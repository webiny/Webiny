...
class Dialog extends Webiny.Ui.Component {
    ...
    componentWillUpdate(nextProps, nextState) {
        ...
        if (currentDialog && currentDialog.id !== this.id && nextState.isShown) {
            ...
            this.props.dynamics.animate(modal[0], {
                opacity: 0,
                translateY: -100
            }, {
                type: this.props.dynamics.easeOut,
            ...
            this.props.dynamics.animate(backdrop[0], {
                opacity: 0
            }, {
                type: this.props.dynamics.easeOut,
    ...
    show() {
        ...
        if (this.isShown()) {
            ...
            return new Promise(resolve => {
                ...
                this.props.dynamics.animate(prevModal[0], {
                    opacity: 1,
                    translateY: 50
                }, {
                    type: this.props.dynamics.spring,
                ...
                this.props.dynamics.animate(prevBackdrop[0], {
                    opacity: 0.8
                }, {
                    type: this.props.dynamics.easeIn,
...
Dialog.defaultProps = {
    ...
    renderDialog() {
        ...
        return (
            <div style={_.merge({}, {display: 'block'}, style)}>
                ...
                <Animate
                    ...
                    <div className="modal-backdrop" style={{opacity: 0}}/>
                </Animate>
