...
class EntityBox extends Webiny.Ui.Component {
     ...
     */
    renderCustomMethods() {
        const {Input, entity, permissions, onTogglePermission} = this.props;
                    ...
                    <div>
                        <div>
                            ...
                            {/*   {m.description && m.name ? (
                             ...
                             <i className="help-icon icon-help"/>
                             </Tooltip>
                             ) : (
                             <i className="help-icon icon-help missing"/>
                             )}*/}
                        </div>
...
export default Webiny.createComponent(EntityBox, {
    modules: ['Icon', 'Input', 'Button', 'ClickConfirm']
});
